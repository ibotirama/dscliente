...
public class ClientResource {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<ClientDTO> update(@PathVariable Long id, @RequestBody ClientDTO categoryDTO) {
		ClientDTO dto = service.update(id, categoryDTO);
		return ResponseEntity.ok().body(dto);
	}

	@PostMapping
	public ResponseEntity<ClientDTO> insert(@RequestBody ClientDTO categoryDTO) {
		ClientDTO dbDto = service.insert(categoryDTO);
